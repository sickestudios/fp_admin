...
<div class="row">
	...
	<legend><?php echo __('Add Review'); ?></legend>
			<div class="row">
				<div class="span12">
					<h3	>Cover title: <?php echo key($cover_data); ?></h3>
				</div>
				<div class="span12">
					<?php echo $this->Html->image($cover_data[key($cover_data)],array('class'=>'img-polaroid')); ?>
					<br><br>
				</div>
				<div class="span12"><?php echo $this->Form->input('title',array('label' => 'Cover title for this language','class'=>'span6','id'=>'input_url','maxlength'=>66,'value'=>key($cover_data))); ?></div>
				<div class="span12"><?php echo $this->Form->input('url',array('label' => 'Cover url for this language','class'=>'span6','id'=>'permalink','maxlength'=>47)); ?></div>
				<div class="urlpe span12"></div>
				...
				<?php echo $this->Form->input('cover_id',array('type'=>'hidden','value'=>$this->request->params['pass'][0])); ?>
				<?php echo $this->Form->input('language_id',array('type'=>'hidden','value'=>$this->request->params['pass'][1])); ?>
				
				<?php echo $this->Form->input('languageid',array('type'=>'hidden','value'=>$this->request->params['pass'][1])); ?>
				<?php echo $this->Form->input('pageid',array('type'=>'hidden','value'=>$this->request->params['pass'][2])); ?>
				
			</div>
	</fieldset>
	</div>
	<div class="row">
		<div class="span3"><?php echo $this->Html->link('Cancel',array('controller'=>'covers','action'=>'index',$this->request->params['pass'][1],'page'=>$this->request->params['pass'][2]),array('class'=>'btn btn-danger span2')); ?></div>
